...
@Transactional
public class Instrument2AggregatorTest {
    ...
    public void testAggregationCase2() {
        ...
        //given
        String line1 = "INSTRUMENT1,13-Jan-2016,1.5";
        String line2 = "INSTRUMENT2,11-Nov-2014,1.5";
        String line3 = "INSTRUMENT1,13-Jan-2016,1.5";
    ...
    public void testAggregationCase3() {
        ...
        //given
        String line1 = "INSTRUMENT2,13-Jan-2016,1.5";
        String line2 = "INSTRUMENT2,11-Nov-2014,1.5";
        String line3 = "INSTRUMENT2,20-Nov-2014,1.5";
    ...
    @Test
    @Rollback(true)
    public void testAggregationCase4() {

        //given
        String line1 = "INSTRUMENT3,13-Jan-2016,1.5";
        String line2 = "INSTRUMENT2,13-Nov-2014,1.5";
        String line3 = "INSTRUMENT4,13-Jan-2016,1.5";

        Instrument instrument = new Instrument(null, "INSTRUMENT2", 3.0);
